...
class NodeTest < Minitest::Test
  def test_node_methods_exist
    reader = Node.new(9)
    assert reader.respond_to?(:insert)
  end
  ...
  def test_links_two_nodes_to_parent_in_order
    ...
    child1 = Node.new(24)
    child2 = Node.new(57)
    parent_node.insert(child1)
    parent_node.insert(child2)
  ...
  def test_links_three_nodes_rightlink_rightlink
    ...
    node2 = Node.new(24)
    node3 = Node.new(36)
    node1.insert(node2).insert(node3)
  ...
  def test_depth_of_level_two
    ...
    node3 = Node.new(24)
    node4 = Node.new(12)
    node1.insert(node2).insert(node3).insert(node4)
